...
class PluginsIdImagesGet200Response(BaseModel):
    """
    ...
    image_urls: Optional[List[StrictStr]] = Field(default=None, description="List of image URLs", alias="imageUrls")
    __properties: ClassVar[List[str]] = ["thumbnailUrl", "imageUrls"]
